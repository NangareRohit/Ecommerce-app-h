	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Anmol Trading Company</a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			...
			<form class="navbar-form navbar-left">
		     ...
		     <button style=" color: white; border-radius: 4px; background-color: #44ab9c; margin-top: 5px; padding: 6px 12px; " onclick="myFunction()">Dark mode</button>
...
function myFunction() {
   ...
   element.classList.toggle("dark-mode");
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> Cart <span class="badge" >0</span>
				</a>
