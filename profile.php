	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">Anmol Trading Company</a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
			 ...
			 <button style=" color: white; border-radius: 4px; background-color: #44ab9c; margin-top: 8px; padding: 6px 12px; margin-left: 40px;" onclick="myFunction()">Dark mode</button>
